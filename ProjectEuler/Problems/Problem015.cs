...
namespace ProjectEuler.Problems
{
    ...
    /// </summary>
    internal class Problem015 : ProblemBase
    {
        private IDictionary<BigInteger, BigInteger> _factorials;

        public Problem015() : base(15, "Lattice paths")
        {
            _factorials = new Dictionary<BigInteger, BigInteger>();
        }
