...
namespace ProjectEuler.Problems
{
    ...
    /// </summary>
    internal class Problem018 : ProblemBase
    {
        public Problem018() : base(18, "Maximum path sum I") { }
        ...
        private int[] GetMax(int[] treeRow)
        {
            var max = new int[treeRow.Length - 1];

            for (int i = 0; i < treeRow.Length - 1; i++)
                max[i] = Math.Max(treeRow[i], treeRow[i + 1]);
